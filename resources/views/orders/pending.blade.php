...
@section('content')
    ...
    <div class="pagetitle">
        <div class="row">
            ...
            <div class="col-4">
                <a href="{{ route('orders.sync_pending') }}" style="float: right" class="btn btn-primary">Sync Pending Payment
                    Orders</a>
            </div>
        </div>
    </div><!-- End Page Title -->
                                        ...
                                        @foreach ($orders as $key => $order)
                                            @if ($order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn-link"
                                                            href="{{ route('shopify.order.show', $order->table_id) }}">{{$store->site_symbol}}-{{ $order->order_number }}</a>
                                                    </td>
                                                    @php
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3">
                                                                <a class="btn btn-success"
                                                                    href="{{ route('orders.update_payment_status', $order->id) }}"
